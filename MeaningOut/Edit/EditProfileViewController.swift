...
//        navigationController?.navigationBar.topItem?.title = ""
        ...
        listCollectionView.register(EditProfileCollectionViewCell.self, forCellWithReuseIdentifier: EditProfileCollectionViewCell.id)
...
extension EditProfileViewController : UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: EditProfileCollectionViewCell.id, for: indexPath) as! EditProfileCollectionViewCell
        let data = UserDefaults.standard.array(forKey: "imageList")
//        let imagedata = UserDefaults.standard.string(forKey: "afterprofileimage")
//        let mainimage = UIImage(named: imagedata!)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        print("선택한 이미지 \(imageSelect) 선택한 셀\(indexPath.item)")
